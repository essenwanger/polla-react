...
export default {
  ...
  radioSelectedColorAndroid: "#00AE33",
  radioBtnLineHeight: platform === "ios" ? 29 : 24,
  radioColor: this.brandPrimary,

  // Segment
  segmentBackgroundColor: platform === "ios" ? "#F8F8F8" : "#00AE33",
  segmentActiveBackgroundColor: platform === "ios" ? "#007aff" : "#fff",
  segmentTextColor: platform === "ios" ? "#007aff" : "#fff",
  segmentActiveTextColor: platform === "ios" ? "#fff" : "#00AE33",
  segmentBorderColor: platform === "ios" ? "#007aff" : "#fff",
  segmentBorderColorMain: platform === "ios" ? "#a7a6ab" : "#00AE33",
